...
\date{\today}
\title{Modelos discretos en epidemiología}
...
\input{imports/autoria}

\input{imports/resumen}

\input{imports/agradecimientos}
...
\input{chapters/capitulo_2}

\input{chapters/capitulo_3}
