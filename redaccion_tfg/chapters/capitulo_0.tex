...
En \ref{fig: cobweb_2.8} podemos ver como el punto de equilibrio $x^*=0$ es inestable y como el otro punto de equilibrio $x^*=1-\frac{1}{\mu}$ es localmente asintóticamente estable.

Asimismo, en \ref{fig: cobweb_3.8} observamos como ambos puntos de equilibrio son inestables.
