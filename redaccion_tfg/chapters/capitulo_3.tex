...
\item \textbf{Scipy}. Scipy es una librería de código abierto para python que proporciona algoritmos para optimización, integración, ecuaciones diferenciales y estadística, entre otros. Se ha usado principalmente para optimizar, integrar en los modelos continuos y realizar los ajustes. 
...
De esta manera, basta con ejecutar el contenedor docker, accesible en Dockerhub, descargarlo y ejecutarlo. El contenedor puede obtenerse \href{https://hub.docker.com/repository/docker/mapachana/plotsir}{aquí}.
