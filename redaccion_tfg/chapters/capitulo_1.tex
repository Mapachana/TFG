...
A medida que los individuos susceptibles decrecen los recuperados aumentan, en particular se ve un decrecimiento exponencial˘. Esto se debe a que los individuos susceptibles primero deben infectarse y luego recuperarse, y, como ya hemos visto en la figura \ref{fig: SIR_IsobreS} los infectados bajan muy rápidamente cuando las personas susceptibles son pocas, por ello los recuperados también crecen rápidamente a menor número de individuos susceptibles.
...
\textcolor{red}{AÑADIR EL MODELO KMK difernecias y comparación y alguna grafiquilla}
