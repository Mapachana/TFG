...
\textcolor{red}{¿Por qué es menor o igual y no menor estricto?}
...
\dfrac{dI}{dt} = I\left(\frac{\alpha}{N}S-\gamma \right) \\
\dfrac{dR}{dt} = R+\gamma I
\end{cases}
\end{equation}
